<?php
	include('../connect.php');
	$id=$_GET['id'];
	$result = $link->prepare("SELECT * FROM customer WHERE customer_id= :userid");
...
<!-- <span>Product Name : </span><textarea style="width:265px; height:60px;" name="prod_name"></textarea><br>
<span>Total : </span><input type="text" style="width:265px; height:30px;" name="memno" value="" /><br>
<span>Note : </span><textarea style="height:60px; width:265px;" name="note"></textarea><br>
<span>Expected Date: </span><input type="date" style="width:265px; height:30px;" name="date" value="" placeholder="Date"/><br> -->
