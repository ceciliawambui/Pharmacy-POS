...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				include('../connect.php');
				$result = $link->prepare("SELECT * FROM sales_order ORDER BY transaction_id DESC");
				$result->execute();
			...
			<tr>
				...
				<?php
				$resultas = $link->prepare("SELECT sum(amount) from sales_order");
				...
				<th colspan="1"><strong style="font-size: 13px; color: #222222;">
				<?php
				$resultas = $link->prepare("SELECT sum(profit) from sales_order");
