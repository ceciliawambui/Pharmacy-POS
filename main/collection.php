...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$result = $link->prepare("SELECT * FROM collection WHERE date BETWEEN :a AND :b");
	...
	<thead>
		<tr>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$results = $link->prepare("SELECT sum(amount) FROM collection WHERE date BETWEEN :a AND :b");
